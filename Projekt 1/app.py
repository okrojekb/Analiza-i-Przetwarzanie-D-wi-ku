...
upload_menu.add_command(label='Załaduj plik',
                        command=lambda: menu_function(fig1, canvas1, sl, 1, scrollbar, scrollbar2, slider2, slider3, labelVSTD, canvas_widget2))
menu.add_cascade(label='Plik', menu=upload_menu)

# Submenus
params_menu = Menu(menu, tearoff=0)
params_menu.add_command(label='Głośność',
                        command=lambda: menu_function(fig2, canvas2, sl, 2, scrollbar, scrollbar2, slider2, slider3, labelVSTD, canvas_widget2))
params_menu.add_command(label='Short Time Energy (STE)',
                        command=lambda: menu_function(fig2, canvas2, sl, 3, scrollbar, scrollbar2, slider2, slider3, labelVSTD, canvas_widget2))
params_menu.add_command(label='Zero Crossing Rate (ZCR)',
                        command=lambda: menu_function(fig2, canvas2, sl, 4, scrollbar, scrollbar2, slider2, slider3, labelVSTD, canvas_widget2))
params_menu.add_command(label='Silent Ratio (SR)',
                        command=lambda: menu_function(fig2, canvas2, sl, 5, scrollbar, scrollbar2, slider2, slider3, labelVSTD, canvas_widget2))

params_menu.add_command(label='Częstotliwość tonu podstawowego F0 - z autokorelacji',
                        command=lambda: menu_function(fig2, canvas2, sl, 6, scrollbar, scrollbar2, slider2, slider3, labelVSTD, canvas_widget2))

params_menu.add_command(label='Częstotliwość tonu podstawowego F0 - z AMDF',
                        command=lambda: menu_function(fig2, canvas2, sl, 7, scrollbar, scrollbar2, slider2, slider3, labelVSTD, canvas_widget2))
...
clip_params_menu.add_command(label='Bazujące na głośności: VSTD, VDR, VU',
                        command=lambda: menu_function(fig2, canvas2, sl, 8, scrollbar, scrollbar2, slider2, slider3, labelVSTD, canvas_widget2))

clip_params_menu.add_command(label='Bazujące na energii: LSTER, Energy Entropy',
                        command=lambda: menu_function(fig2, canvas2, sl, 9, scrollbar, scrollbar2, slider2, slider3, labelVSTD, canvas_widget2))
...
scrollbar2 = Scale(root, from_=0, to=100, orient=HORIZONTAL, length=1100,
                   command=lambda value: scroll_function(fig2, canvas2, int(value), sl, slider2, slider3, scrollbar, scrollbar2))
